...
#define BACKLASH_COMPENSATION
  ...
  #define BACKLASH_DISTANCE_MM { 5, 5, 2 } // (linear=mm, rotational=°) One value for each linear axis
...
#define BEEP_ON_FEEDRATE_CHANGE
  ...
  #define SPEED_EDIT_MIN     1  // (%) Feedrate percentage edit range minimum
  #define SPEED_EDIT_MAX   500  // (%) Feedrate percentage edit range maximum
#endif
#if HAS_FLOW_EDIT
  #define FLOW_EDIT_MIN      1  // (%) Flow percentage edit range minimum
  #define FLOW_EDIT_MAX    500  // (%) Flow percentage edit range maximum
#endif
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define SD_PROCEDURE_DEPTH 5              // Increase if you need more nested M32 calls
  ...
  #define EVENT_GCODE_SD_ABORT "G27\nG0F300Y220"      // G-code to run on SD Abort Print (e.g., "G28XY" or "G27")
  ...
  #define POWER_LOSS_RECOVERY
    ...
    #define PLR_BED_THRESHOLD 45 // (°C) Skip user confirmation at or above this bed temperature (0 to disable)
...
#define FWRETRACT
  ...
  #define RETRACT_FEEDRATE            180   // (mm/s) Default feedrate for retracting
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_SLOW_LOAD_FEEDRATE   45  // (mm/s) Slow move when starting load.
  #define FILAMENT_CHANGE_SLOW_LOAD_LENGTH    25  // (mm) Slow length, to allow time to insert material.
                                                  // 0 to disable start loading and skip to fast load only
  #define FILAMENT_CHANGE_FAST_LOAD_FEEDRATE   180  // (mm/s) Load filament feedrate. This can be pretty fast.
...
#define PHOTO_GCODE
  ...
  #define PHOTO_POSITION { X_MAX_POS - 5, Y_MAX_POS, 5 }  // { xpos, ypos, zraise } (M240 X Y Z)
...
//#define NO_VOLUMETRICS
  ...
  #define VOLUMETRIC_EXTRUDER_LIMIT
     ...
     */
    #define DEFAULT_VOLUMETRIC_EXTRUDER_LIMIT  12.1     // (mm^3/sec)
    #define VOLUMETRIC_EXTRUDER_LIMIT_MAX     1000        // (mm^3/sec)
  #endif
#endif
